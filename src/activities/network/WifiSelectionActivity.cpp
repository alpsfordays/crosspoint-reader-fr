...
void WifiSelectionActivity::renderConnected() const {
  ...
  renderer.drawCenteredText(SMALL_FONT_ID, pageHeight - 30, "Appuyez un bouton pour continuer");
}
...
void WifiSelectionActivity::renderSavePrompt() const {
  ...
  renderer.drawCenteredText(SMALL_FONT_ID, pageHeight - 30, "GAUCHE/DROITE : Select. | OK : Confirm.");
}
