...
void EpubReaderChapterSelectionActivity::renderScreen() {
  ...
  const int titleX =
      contentX + (contentWidth - renderer.getTextWidth(UI_12_FONT_ID, "Aller au chapitre", EpdFontFamily::BOLD)) / 2;
  renderer.drawText(UI_12_FONT_ID, titleX, 15 + contentY, "Aller au chapitre", true, EpdFontFamily::BOLD);
