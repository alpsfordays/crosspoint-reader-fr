...
#define NOTOSANS_12_FONT_ID (715960401)
#define NOTOSANS_14_FONT_ID (893870050)
#define NOTOSANS_16_FONT_ID (-533800565)
#define NOTOSANS_18_FONT_ID (-1422419289)
...
#define SMALL_FONT_ID (-148443313)
